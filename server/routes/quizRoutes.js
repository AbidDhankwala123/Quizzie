...
const { createQuiz,updateQuiz,deleteQuiz,getAllQuizByUserId,getQuizByIdAndIncreaseImpressionsByOne } = require("../controllers/quizController");
const isAuthenticated = require("../middleware/authMiddleware");
const router = express.Router();

router.get("/getAllQuiz/:quizOwnerId",isAuthenticated,getAllQuizByUserId);//get all quizzes
router.get("/:id",getQuizByIdAndIncreaseImpressionsByOne);//get guiz by id and increment impressions count by 1
